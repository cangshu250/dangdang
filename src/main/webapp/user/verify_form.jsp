...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/user/user_vertify" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						...
						<span class="t1"> 
						请登录您的邮箱收信。输入验证码或者点击超链接激活账号。
						</span>
					</div>
					<h4>
						第二步：输入验证码 	${sessionScope.emailCode}
					</h4>
					<div class="mess">
						...
						<span id="errorMsg" class="no_right">${param.message}</span>
					</div>
				</div>
			</div>
		</form>
